          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="inline-flex items-center gap-2 bg-navy/10 border border-navy/30 rounded-full px-4 py-2 mb-6">
                ...
                <span className="text-sm font-medium text-navy">Vice President of the United States</span>
              </div>
      ...
      <section className="py-16 bg-secondary/30">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-navy font-bold">— Ethan Landrigan</p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            >
              <div className="bg-card p-6 rounded-lg border border-border">
                <h3 className="text-xl font-bold text-navy mb-4">Role in Administration</h3>
              ...
              <div className="bg-card p-6 rounded-lg border border-border">
                <h3 className="text-xl font-bold text-navy mb-4">Key Responsibilities</h3>
                <ul className="space-y-2 text-muted-foreground">
                  <li className="flex items-start gap-2">
                    <Star className="h-4 w-4 text-navy mt-1 flex-shrink-0" />
            ...
            >
              <h3 className="text-xl font-bold text-navy mb-4">Partnership with President Wong</h3>
                ...
                {[
                  ...
                  <li key={item} className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-navy/10 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <Star className="h-3 w-3 text-navy" />
                    </div>
